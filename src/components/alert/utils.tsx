import { RequiredAlertProps, AlertPositionType } from "./type";

// RequiredAlertProps prevents Type Error
export const wrapperClasses: Record<RequiredAlertProps["type"], string> = {
...
// RequiredAlertProps prevents Type Error
export const iconClasses: Record<RequiredAlertProps["type"], string> = {
...
// return alert icon based on the alert type
export const getIcon = (type: RequiredAlertProps["type"]) => {
...
export const positionClasses: Record<AlertPositionType, string> = {
...
export const animationVariables: Record<AlertPositionType, string> = {
